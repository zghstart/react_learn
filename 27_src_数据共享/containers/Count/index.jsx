...
import {decrementAction, incrementAction,incrementAsyncAction} from "../../redux/action/count";
...
class Count extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <h2>我是Count组件,Person组件的大小为为 {this.props.person.length}</h2>
                <h2>当前求和为：{this.props.cnt}</h2>
